...
import 'package:viavita_new_customer/Shopkeeper/BottomScreen/bottompage.dart';
import 'package:viavita_new_customer/Shopkeeper/SKForgetPasswordScreen/sk_forgetpasswordscreen.dart';
import 'package:viavita_new_customer/Worker/BottomScreen/worker_bottomscreen.dart';
import 'package:viavita_new_customer/Worker/WorkerForgetPasswordScreen/worker_forgetpasswordscreen.dart';
import 'package:viavita_new_customer/Worker/WorkerRegisterScreen/worker_registerscreen.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: TextButton(
                  onPressed: () {
                   Navigator.push(context,MaterialPageRoute(builder: (context)=>WorkerForgetpasswordscreen()));
              ...
              Row(
                ...
                children: <Widget>[
                 Text(
                  ...
                  GestureDetector(
                    onTap: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context)=>WorkerRegisterscreen()));
