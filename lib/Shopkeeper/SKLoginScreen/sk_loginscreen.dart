...
class SkLoginscreen extends StatefulWidget {
  const SkLoginscreen({super.key});

  @override
  State<SkLoginscreen> createState() => _SkLoginscreenState();
}

class _SkLoginscreenState extends State<SkLoginscreen> {
  @override
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: TextButton(
                  onPressed: () {
                   Navigator.push(context,MaterialPageRoute(builder: (context)=>SkForgetpasswordscreen()));
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ShopBottomNavigationSCreen()));
                },
                child: Container(
                  height: 55,
                  width: 390,
