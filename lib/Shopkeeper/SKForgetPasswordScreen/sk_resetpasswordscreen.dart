...
class SkResetpasswordscreen extends StatefulWidget {
  const SkResetpasswordscreen({super.key});

  @override
  State<SkResetpasswordscreen> createState() => _SkResetpasswordscreenState();
}

class _SkResetpasswordscreenState extends State<SkResetpasswordscreen> {
